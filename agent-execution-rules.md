...
This file is the canonical execution-governance source for AI-assisted delivery in this repository set.
...
Do not offer the next step separately if it is already an obvious part of the requested workflow.
Carry the task through end-to-end with as little back-and-forth as safely possible.
The user's request is implicit authorization for all necessary related execution steps.
